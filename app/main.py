...
from app.routers import users, appointments, admin
from app.admin_auth import admin_required  # Middleware/función para validar admin
...
# Página para crear horarios (solo admin)
